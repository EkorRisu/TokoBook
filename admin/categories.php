...
<head>
    ...
    <title>TokoBook - Categories</title>
                            ...
                            <tbody>
                                <?php foreach($cats as $c): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="category_edit.php?id=<?php echo $c['id']; ?>" class="btn btn-sm btn-primary">Edit</a>
                                            <a href="category_delete.php?id=<?php echo $c['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete?')">Delete</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
